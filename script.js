...
const LETTER_CONTENT = {
    sad: {
        ...
        message: "I know things feel heavy right now, but please remember that this feeling is temporary. You've overcome difficult moments before, and you will again. Your strength is incredible, even when you don't feel it. Take a deep breath, be kind to yourself, and know that brighter days are ahead. You are loved, you matter, and you are never truly alone. I'm always here for you, even from afar. يارب متفتحيش المكان ده خالص يعني و تكوني دايما مبسوطة يا سندسس"
    },
    doubt: {
